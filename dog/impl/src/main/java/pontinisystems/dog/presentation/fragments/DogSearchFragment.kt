...
import pontinisystems.dog.impl.R
import pontinisystems.dog.impl.databinding.DogSearchFragmentBinding
...
class DogSearchFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private val loadModules by lazy {
        unloadKoinModules(dogModuleDependency)
        loadKoinModules(dogModuleDependency)
    }
